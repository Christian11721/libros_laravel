...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						<div class="app-sidebar-header d-flex flex-stack d-none d-lg-flex pt-8 pb-2" id="kt_app_sidebar_header">
							...
							<a href="index.html" class="app-sidebar-logo">
								<img alt="Logo" src={{asset('media/logos/demo38.svg')}} class="h-25px d-none d-sm-inline app-sidebar-logo-default theme-light-show" />
								<img alt="Logo" src={{asset('media/logos/demo38-dark.svg')}} class="h-20px h-lg-25px theme-dark-show" />
							</a>
							<!--end::Logo-->
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												...
												<a class="menu-link" href="index.html">
													...
													<span class="menu-title">Carnitas</span>
												</a>
												<!--end:Menu link-->
											</div>
											<!--end:Menu item-->
											...
											<div class="menu-item">
												...
												<a class="menu-link" href="dashboards/ecommerce.html">
													...
													<span class="menu-title">Birria</span>
												</a>
												<!--end:Menu link-->
											</div>
											<!--end:Menu item-->
